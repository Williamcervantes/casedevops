...
export declare namespace CfnMalwareProtectionPlan {
    ...
    interface CFNStatusReasonsProperty {
         ...
         *
         * For information about potential troubleshooting steps, see [Troubleshooting Malware Protection for S3 status issues](https://docs.aws.amazon.com/guardduty/latest/ug/troubleshoot-s3-malware-protection-status-errors.html) in the *GuardDuty User Guide* .
         *
