...
import { IAliasRecordTarget } from 'aws-cdk-lib/aws-route53/lib/alias-record-target';
import { GeoLocation } from 'aws-cdk-lib/aws-route53/lib/geo-location';
import { IHealthCheck } from 'aws-cdk-lib/aws-route53/lib/health-check';
