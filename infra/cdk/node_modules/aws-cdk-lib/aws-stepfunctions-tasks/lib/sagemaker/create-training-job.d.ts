...
import { AlgorithmSpecification, Channel, OutputDataConfig, ResourceConfig, StoppingCondition, VpcConfig } from 'aws-cdk-lib/aws-stepfunctions-tasks/lib/sagemaker/base-types';
