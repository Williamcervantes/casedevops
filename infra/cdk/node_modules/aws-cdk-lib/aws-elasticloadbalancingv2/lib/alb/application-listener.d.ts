...
import { ListenerAction } from 'aws-cdk-lib/aws-elasticloadbalancingv2/lib/alb/application-listener-action';
import 'aws-cdk-lib/aws-elasticloadbalancingv2/lib/alb/application-listener-rule';
import { IApplicationLoadBalancer } from 'aws-cdk-lib/aws-elasticloadbalancingv2/lib/alb/application-load-balancer';
import { ApplicationTargetGroup, IApplicationLoadBalancerTarget, IApplicationTargetGroup } from 'aws-cdk-lib/aws-elasticloadbalancingv2/lib/alb/application-target-group';
import { ListenerCondition } from 'aws-cdk-lib/aws-elasticloadbalancingv2/lib/alb/conditions';
import { ITrustStore } from 'aws-cdk-lib/aws-elasticloadbalancingv2/lib/alb/trust-store';
import * as ec2 from 'aws-cdk-lib/aws-ec2';
import { Duration } from 'aws-cdk-lib/core';
import { BaseListener, BaseListenerLookupOptions, IListener } from 'aws-cdk-lib/aws-elasticloadbalancingv2/lib/shared/base-listener';
import { HealthCheck } from 'aws-cdk-lib/aws-elasticloadbalancingv2/lib/shared/base-target-group';
import { ApplicationProtocol, ApplicationProtocolVersion, TargetGroupLoadBalancingAlgorithmType, SslPolicy } from 'aws-cdk-lib/aws-elasticloadbalancingv2/lib/shared/enums';
import { IListenerCertificate } from 'aws-cdk-lib/aws-elasticloadbalancingv2/lib/shared/listener-certificate';
/**
