import { ContainerOverride, EphemeralStorageOverride, InferenceAcceleratorOverride } from 'aws-cdk-lib/aws-events-targets/lib/ecs-task-properties';
import { TargetBaseProps } from 'aws-cdk-lib/aws-events-targets/lib/util';
