...
import { CfnSourceApiAssociation } from 'aws-cdk-lib/aws-appsync/lib/appsync.generated';
import { IGraphqlApi } from 'aws-cdk-lib/aws-appsync/lib/graphqlapi-base';
 ...
 */
export declare function addSourceGraphQLPermission(sourceApiAssociation: CfnSourceApiAssociation, mergedApiExecutionRole: IRole): import("aws-cdk-lib/aws-iam").AddToPrincipalPolicyResult;
/**
 ...
 * @param mergedApiExecutionRole The merged api execution role on which to add the permission.
 */
export declare function addSourceApiAutoMergePermission(sourceApiAssociation: CfnSourceApiAssociation, mergedApiExecutionRole: IRole): import("aws-cdk-lib/aws-iam").AddToPrincipalPolicyResult;
