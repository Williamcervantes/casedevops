...
import { AppSyncAuthorizationType } from 'aws-cdk-lib/aws-appsync/lib/auth-config';
import { Code } from 'aws-cdk-lib/aws-appsync/lib/code';
import { IEventApi } from 'aws-cdk-lib/aws-appsync/lib/eventapi';
...
export declare class ChannelNamespace extends Resource implements IChannelNamespace {
     ...
     */
    grantSubscribe(grantee: IGrantable): import("aws-cdk-lib/aws-iam").Grant;
    /**
     ...
     * @param grantee The principal
     */
    grantPublish(grantee: IGrantable): import("aws-cdk-lib/aws-iam").Grant;
    /**
     ...
     * @param grantee The principal
     */
    grantPublishAndSubscribe(grantee: IGrantable): import("aws-cdk-lib/aws-iam").Grant;
