...
import { IApi, ApiBase } from 'aws-cdk-lib/aws-appsync/lib/api-base';
import { AppSyncLogConfig, AppSyncDomainOptions, AppSyncEventResource } from 'aws-cdk-lib/aws-appsync/lib/appsync-common';
import { CfnApiKey } from 'aws-cdk-lib/aws-appsync/lib/appsync.generated';
import { AppSyncAuthorizationType, AppSyncAuthProvider } from 'aws-cdk-lib/aws-appsync/lib/auth-config';
import { ChannelNamespace, ChannelNamespaceOptions } from 'aws-cdk-lib/aws-appsync/lib/channel-namespace';
